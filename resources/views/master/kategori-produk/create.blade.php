...
@section('breadcrumb', 'Master / Kategori Produk / Tambah')
@section('page-title', 'Tambah Kategori Produk')

@section('content')
<div class="content-header">
    <div>
        <h2 style="color: var(--primary); font-size: 28px; margin-bottom: 4px;">Tambah Kategori Produk</h2>
        <p style="color: var(--text-secondary);">Lengkapi form di bawah untuk menambah kategori produk</p>
    </div>
                ...
                <div>
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror"
                            value="{{ old('nama') }}" placeholder="Contoh: Makanan, Minuman, ATK" required>
                        @error('nama')
                    ...
                    <div class="form-group">
                        ...
                        <div style="display: flex; gap: 8px; align-items: center;">
                            <input type="text" name="ikon" id="ikon-input" class="form-control @error('ikon') is-invalid @enderror"
                                value="{{ old('ikon') }}" placeholder="Contoh: fas fa-box">
                            <div id="ikon-preview" style="min-width: 44px; height: 44px; background: var(--bg-body); border: 1px solid var(--border-color); border-radius: 10px; display: flex; align-items: center; justify-content: center;">
                                <i id="ikon-preview-icon" class="{{ old('ikon', 'fas fa-tag') }}" style="font-size: 20px; color: var(--primary);"></i>
                            </div>
                        </div>
                        @error('ikon')
                    ...
                    <div class="form-group">
                        ...
                        <div style="display: flex; flex-wrap: wrap; gap: 8px;">
                            ...
                            <button type="button" class="btn btn-sm icon-pick-btn"
                                style="background: var(--bg-body); border: 1px solid var(--border-color); border-radius: 8px; padding: 6px 10px; display: flex; flex-direction: column; align-items: center; gap: 4px; cursor: pointer;"
...
<script>
    function setIkon(iconClass) {
        ...
        document.getElementById('ikon-preview-icon').className = iconClass + ' fa-lg';
