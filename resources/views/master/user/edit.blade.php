...
@section('breadcrumb', 'Admin / User / Edit')
@section('page-title', 'Edit User')

@section('content')
    <div class="content-header">
        <div>
            <h2 style="color: var(--primary); font-size: 28px; margin-bottom: 4px;">Edit User</h2>
            <p style="color: var(--text-secondary);">Perbarui data akun <strong>{{ $user->name }}</strong></p>
        </div>
